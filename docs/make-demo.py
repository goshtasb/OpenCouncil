...
(logs under ~/.council/projects/<repo>-<hash>/sessions/<id>/HISTORY.log and the run output).
...
LINES = [
    (0.0,  "$ council open gates-command --item 002", "cmd"),
    (1.0,  "20260917213447-gates-command", "dim"),
    (1.6,  "$ council deliberate 20260917213447-gates-command", "cmd"),
    ...
    (21.0, "$ council approve 20260917213447-gates-command \"APPROVE 41f920af\"", "cmd"),
    (22.4, "✔ Session successfully APPROVED.   <- the only human step", "ok"),
    (23.6, "$ council run 20260917213447-gates-command", "cmd"),
    ...
    (31.2, "✔ Pull Request: github.com/goshtasb/OpenCouncil/pull/1", "ok"),
...
svg = f'''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}" role="img"
     aria-label="A real Open Council session: Gemini drafts a PRD, Claude objects four times, Grok rules and signs off, the operator approves, gates pass, a pull request opens.">
...
<text class="t" x="86" y="24" fill="#8a8f80" font-size="12.5">open-council — a real session, replayed from its transcript</text>
